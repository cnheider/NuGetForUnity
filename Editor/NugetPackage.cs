namespace NuGetForUnity.Editor {
  ...
  public class NugetPackage : NugetPackageIdentifier,
    ...
    public bool Equals(NugetPackage other) { return other._Id == this._Id && other._Version == this._Version; }
    ...
    public static NugetPackage FromNuspec(NuspecFile nuspec) {
      ...
      try {
        package.RepositoryType =
            (RepositoryType)Enum.Parse(enumType : typeof(RepositoryType),
                                       value : nuspec.RepositoryType,
                                       true);
      } catch (Exception) { }
    ...
    public static NugetPackage FromNupkgFile(string nupkgFilepath) {
      var package = FromNuspec(nuspec : NuspecFile.FromNupkgFile(nupkgFilepath : nupkgFilepath));
